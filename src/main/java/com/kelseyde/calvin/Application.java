...
// Borrowed from Serendipity.
public class Application {

    public static void main(String[] args) {

        String jarFileName = "calvin-chess-engine-5.1.0.jar";

        File currentDir;

        try {
            currentDir = new File(Application.class.getProtectionDomain().getCodeSource().getLocation().toURI())
                    .getParentFile();
